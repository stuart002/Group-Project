...
ggplot(DF4, aes(x=`Life Expectancy 2009-13`, y=`Crime rate - 2009-2013`))+geom_point()+geom_smooth()+ coord_trans(x = "log10", y = "log10")
ggplot(DF4, aes(x=`Childhood Obesity 2009-2013`, y=`Crime rate - 2009-2013`))+geom_point()+geom_smooth()+ coord_trans(x = "log10", y = "log10")
ggplot(DF4, aes(x=`Incapacity Benefit rate - 2009-2013`, y=`Crime rate - 2009-2013`))+geom_point()+geom_smooth()+ coord_trans(x = "log10", y = "log10")
