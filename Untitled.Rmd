...
Dependent childing shows the percentage of children living in out-of-work benefit claimant households. 

A moderate positive correlation indicates that boroughs with higher dependent children percentage tends to have higher crime rate.
```{r}
