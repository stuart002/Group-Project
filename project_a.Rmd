...
for (i in 1:length(var_list)){
  cor_test <- cor.test(gb[[var_list[i]]], gb$crime_rate)
  print(var_list[i])
  print(cor_test)
}
cor.test(crime_ward$`Crime rate - 2013`,crime_ward$`Subjective well-being average score, 2013` )
...
>>>>>>> 5557dbbaca3e8b012ebdd87cf1c914ec859e4b0d
