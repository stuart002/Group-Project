...
```{r}
# the codes below define a function that allows you to make scatters with correlation on them
...
cor_plot <- function(col_name) {
  ...
  print(ggplot(crime_ward_long,aes_string(x=col_name,y="crime_rate"))+geom_point(alpha=0.5)+
