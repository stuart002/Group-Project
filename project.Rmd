...
var_2 <- var_1[, 1:3]
kable(var_2, format = "html", options(knitr.kable.NA= ''))
```
...
```{r boroughs_with_high_crime_rate, message=FALSE, warning=FALSE, results='hide',echo=FALSE, fig.height = 4, fig.width = 5, fig.cap="Fig. 2: Crime rate > 90 (2013)"}
...
```{r crime_rate_growth, message=FALSE, warning=FALSE, results='hide',echo=FALSE, fig.height = 4, fig.width = 5, fig.cap="Fig. 3: Decrease of crime rates by borough from 2009 to 2013"}
...
```{r, echo=FALSE, fig.cap="Fig. 4: Crime rates by borough (2009-2013)"}
...
```{r, echo = FALSE, fig.cap="Fig. 5: Distribution of crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 6: Correlation of life expectancy and crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 7: Correlation of childhood obesity and crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 8: Correlation of incapacity benefit and crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 9: Correlation of umemployment rate and crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 10: Correlation of GCSE scores and crime rate"}
cor_plot("GCSE_point")
```
...
```{r, echo=FALSE, fig.cap="Fig. 11: Correlation of unauthorised pupil absence and crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 12: Correlation of dependent children in out-of-work household and crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 13: Correlation of  public transport accessibility and crime rate"}
...
```{r, echo=FALSE, fig.cap="Fig. 14: Correlation matrix"}
...
```{r, echo = FALSE, fig.cap="Fig. 15: Residuals plot"}
