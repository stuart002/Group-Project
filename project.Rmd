...
From 2009 to 2013, the crime rates of all districts in London have decreased. As seen in the maps of the figure below, the districts in the outskirts of London seem to have a lower crime rates than the districts in the center of London with exception to the City of London. Moreover, from plot (Figure 1 and 2), we can see that the crime rate is decreasing from year to year, across all boroughs. 
