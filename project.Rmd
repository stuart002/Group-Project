...
####Access Public Transport Accessibility Scores	
...
ggplot(res_plot, aes(log(crime_ward_2013$crime_rate), Residuals)) +geom_point()+geom_hline(yintercept = 0, color = "red")
```
